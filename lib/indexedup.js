...
require.define("/src/indexedup.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var IDBKeyRange, IDBTransaction, IUDatabase, IndexedUp, ReadableStream, errors, indexedDB, prefixed, stream,
  ...
  IUDatabase = (function() {
    ...
    function IUDatabase(path, _options) {
