...
require.define("/indexedup.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  IUDatabase = (function() {
    ...
    IUDatabase.prototype.put = function(key, val, cb) {
      this.values[key] = val;
      return cb();
    };
    ...
    IUDatabase.prototype.get = function(key, cb) {
      var val;
      if (val = this.values[key]) {
        return cb(null, val);
      } else {
        return cb(new Error('Key not found', null));
      }
    };
  ...
  IndexedUp = function(path, options, cb) {
    return cb(null, new IUDatabase(path, options));
  };
