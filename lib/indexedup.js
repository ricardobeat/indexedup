...
require.define("/indexedup.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var IDBKeyRange, IDBTransaction, IUDatabase, IndexedUp, ReadableStream, indexedDB, prefixed, stream,
  ...
  IUDatabase = (function() {
    ...
    IUDatabase.prototype.open = function(cb) {
      var request,
        _this = this;
      request = indexedDB.open(this.path);
      request.onsuccess = function(e) {
        _this.db = request.result;
        return cb(null, _this);
      };
      request.onerror = function(e) {
        return cb(new Error("Failed to open IndexedDB (@path)", e));
      };
    ...
    IUDatabase.prototype.get = function(key, cb) {
      ...
      req.onsuccess = function(e) {
        ...
        if (result = (_ref = req.result) != null ? _ref.value : void 0) {
          ...
          return cb(new Error("Key not found in database [" + key + "]", e));
        }
      };
